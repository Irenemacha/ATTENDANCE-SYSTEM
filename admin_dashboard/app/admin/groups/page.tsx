  ...
  return (
    <AdminShell>
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Manage group and permission assignments.</p>
      </div>
        ...
        <Card className="border-slate-200 shadow-sm">
          <CardContent className="pt-6">
            ...
            <div className="grid max-h-[620px] gap-2 overflow-auto pr-2">
              {!selected && <EmptyState icon={Shield} title="Select a group" description="Choose a group to assign permissions." />}
              {selected &&
